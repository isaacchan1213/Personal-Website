        ...
        <div className="max-w-[350px] m-auto md:max-w-[600px] lg:max-w-[800px] flex flex-col md:m-auto items-center">
            ...
            <div className='w-[100%] flex flex-col gap-[15px] content-start'>
                <p className='text-[18px] md:text-[20px]'>
                    ...
                    I started my love for all things tech ever since high school after reluctantly deciding in my sophomore year to signup for my very 
                ...
                <p className='text-[18px] md:text-[20px]'>
                    Fast forwarding to today, I continously immerse myself within this ever growing field. Whether that be through
                    my internship as a Software Engineer at an ed-tech startup, my vital role as VP of Community at a nonprofit
                    dedicated in helping CS majors integrate into the tech industry, or even deepening my software skills as a Fellow, 
