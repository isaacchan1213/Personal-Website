...
function Cover() {
  return (
    <div className="flex flex-col relative items-center max-w-[400px] md:mt-[8rem] mb-[2.5rem] md:max-w-5xl m-auto lg:mb-[80px] lg:mt-[90px] animate-fade-up">
      <div className="flex flex-col-reverse gap-[20px] md:flex-row justify-between items-center">
        ...
        <div className='flex flex-col max-w-md gap-[15px] w-full items-center'>
          ...
          <p className="text-[18px] w-[350px] sm:text-[20px] md:w-[450px] text-left">A passionate and driven individual who is interested in building technical solutions to modern day problems.</p>
          <p className="text-[18px] w-[350px] sm:text-[20px] md:w-[450px] text-left">Feel free to learn more about me below!</p>
        </div>
